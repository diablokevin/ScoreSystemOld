...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.StaffId, RealName=model.RealName, StaffId=model.StaffId};
                
              //user.Roles.Add(new Microsoft.AspNet.Identity.EntityFramework.IdentityUserRole { RoleId= })
                ...
                if (result.Succeeded)
                {
                    ...
                    db.Judges.Add(new Judge { Name = model.RealName, UserId = user.Id ,CompanyId =model.CompanyId,StaffId=model.StaffId});
                    db.SaveChanges();
